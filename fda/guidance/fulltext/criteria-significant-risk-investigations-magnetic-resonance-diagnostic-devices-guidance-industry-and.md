...
You should consider the following operating conditions when assessing whether a study may be considered significant risk: • main static magnetic field • specific absorption rate (SAR)
•
gradient fields rate of change •
sound pressure level Generally, FDA deems magnetic resonance diagnostic devices significant risk when used under any of the operating conditions described below.
...
Site Dose Time (min)
equal to or greater than: SAR (W/kg)
whole body averaged over >4
head averaged over >3.2
