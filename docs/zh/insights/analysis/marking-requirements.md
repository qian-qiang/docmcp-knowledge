---
id: insights-marking-requirements
title:
  zh: 有源医疗器械外部标记要求
  en: ''
type: insight
...
source_url: https://reguverse.com/blog/marking-requirements/
source_format: html
...
wordpress_id: 3291
excerpt:
  zh: '要求来源：GB 9706.1-2020 / IEC 60601-1: 2012；医疗器械说明书和标签管理规定 最低要求（7.2.1）：如果ME设备、部件或附件的尺寸或外壳特征不准许将规定的标记全部标上，则至少应标上下列标记。而其余的标记应在随附文件（如：说明书）中完整地记载。无法做标记的ME设备，这些标记可以贴在独立的包装上。
    如果ME设备预期接收来自ME系统中其他电气设备的电能，且依赖其他电气设'
  en: ''
---

# 有源医疗器械外部标记要求

> 要求来源：GB 9706.1-2020 / IEC 60601-1: 2012；医疗器械说明书和标签管理规定 最低要求（7.2.1）：如果ME设备、部件或附件的尺寸或外壳特征不准许将规定的标记全部标上，则至少应标上下列标记。而其余的标记应在随附文件（如：说明书）中完整地记载。无法做标记的ME设备，这些标记可以贴在独立的包装上。 如果ME设备预期接收来自ME系统中其他电气设备的电能，且依赖其他电气设
...
**最低要求（7.2.1）** ：如果ME设备、部件或附件的尺寸或外壳特征不准许将规定的标记全部标上，则至少应标上下列标记。而其余的标记应在随附文件（如：说明书）中完整地记载。无法做标记的ME设备，这些标记可以贴在独立的包装上。
  ...
  1. 制造商的名称或商标以及联系信息（可拆卸的元器件也应标记）
  2. 型号或类型参考号（可拆卸的元器件也应标记）
  3. 序列号或批号或批次标识
  4. 制造日期或失效日期，若适用
  5. 如适用，软件组件唯一的标识符，诸如：修订版本或发布/颁布日期（该识别不需要标记在ME设备外部）
...
_安全标志应出现在显著位置，使其在ME设备正确安装后的正常使用时清晰易认。使用说明书应描述出危险(源)的性质以及避免或是降低相关风险的预防措施。_
