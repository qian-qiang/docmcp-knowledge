...
Answer:  No.  Only those hospitals that actually reprocess medical devices labeled for single use must comply with FDA’s medical device requirements applicable to manufacturers.
FDA’s regulatory requirements do not apply to hospitals that use a third party reprocessor to reprocess SUDs for reuse.
